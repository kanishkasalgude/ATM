-- =============================================================
-- ATM Cash Management System — FINAL FIXED SCHEMA
-- =============================================================

DROP DATABASE IF EXISTS atm_cash_mgmt;
CREATE DATABASE atm_cash_mgmt;
USE atm_cash_mgmt;
...
-- 🔁 Handle circular dependency safely
ALTER TABLE BRANCH
...
CREATE TABLE CASH_REPLENISHMENT (
